...
class ComfoAirFanBalanceSelect(ComfoAirEntity, SelectEntity):
    ...
    Works by zeroing one fan's per-level percentages via the coordinator
    (CMD_SET_VENTILATION_LEVEL). See ComfoAirCoordinator.async_set_fan_balance
    for the ~15% minimum caveat.
    """
